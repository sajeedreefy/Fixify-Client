...
import { ShimmerTitle, ShimmerText, ShimmerSimpleGallery, ShimmerButton } from 'react-shimmer-effects';
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="troo_da_people_choose_left">
              {loadData?
                <div style={{ marginBottom: '20px', opacity:".2"}}>
              ...
              {loadData?
                <div style={{ marginBottom: '15px', opacity:".2" }}>
              ...
              <div class="people_choose_btn">
                ...
                {loadData?
                  <div style={{ padding: '20px', opacity:".2" }}>
          ...
          <div class="col-lg-6">
            {loadData?
                <div style={{ marginTop: '20px', opacity:".2" }}>
                  <ShimmerSimpleGallery card={4} imageHeight={140}/>
                </div>:
